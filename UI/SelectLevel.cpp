...
void SelectLevel::initUI()
{
	...
	_images[0] = utils->add_button("level_1.png", temp);
	...
	_images[1] = utils->add_button("level_2.png", temp);
	...
	_images[2] = utils->add_button("level_3.png", temp);
	...
	_images[3] = utils->add_button("level_4.png", temp);
	...
	_images[4] = utils->add_button("level_5.png", temp);
