...
SOURCES     += UI/mainwindow.cpp atariBreakout.cpp inputs/PhysicalController.cpp inputs/Controller.cpp inputs/Keyboard.cpp Balle.cpp Brique.cpp Briquetest.cpp BriqueA.cpp BriqueB.cpp BriqueC.cpp BriqueT.cpp BriqueVoid.cpp Level.cpp menu.cpp Plateforme.cpp GameLogic.cpp Canevas.cpp GameLoop.cpp Powerups.cpp Extendplatform.cpp Addballs.cpp Swapcontrol.cpp lib/SerialPort.cpp
INCLUDEPATH += ../atariBreakout ../atariBreakout/inputs ../atariBreakout/lib ../atariBreakout/lib ../atariBreakout/components ../atariBreakout/UI
QT          += widgets
