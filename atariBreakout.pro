...
=======
HEADERS     += inputs/Controller.h inputs/Keyboard.h components/components.h Balle.h Brique.h Briquetest.h Level.h menu.h Plateforme.h Structs.h Powerups.h
SOURCES     += keyboardTest.cpp inputs/Controller.cpp inputs/Keyboard.cpp Balle.cpp Brique.cpp Briquetest.cpp Level.cpp menu.cpp Plateforme.cpp Powerups.cpp
>>>>>>> Stashed changes
