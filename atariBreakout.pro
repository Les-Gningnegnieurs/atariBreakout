...
SOURCES     += keyboardTest.cpp inputs/Controller.cpp inputs/Keyboard.cpp Balle.cpp Brique.cpp Briquetest.cpp BriqueA.cpp BriqueB.cpp BriqueC.cpp BriqueT.cpp BriqueVoid.cpp Level.cpp menu.cpp Plateforme.cpp GameLogic.cpp Canevas.cpp GameLoop.cpp
